...
const Login = () => {
    ...
    return (
        <div className='container w-50 mx-auto'>
            ...
            <p className="text-danger">Forget Password? <button className='btn btn-link text-primary pe-auto text-decoration-none' onClick={resetPassword}>Reset Password Now</button> </p>
